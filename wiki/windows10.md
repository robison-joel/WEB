...
> [Inicio](index.md) > [Sistemas Operacionais](index.md#Sistemas Operacionais) > [Windows 10](windows10.md)
...
Arquivos recentes e temporários.
...
Erro 80072EFE na atualização
--------------------

Na instalação do Windows 7 a primeira verificação de atualização no Windows Update aparece este erro 80072EFE:

![erro1](pics/erro_win7_1.png)

para que o windows possa verificar as atualizações, você terá que baixar e instalar manualmente uma atualização (constrangedor). Clique no link abaixo para baixá-la:

<https://catalog.s.download.windowsupdate.com/d/msdownload/update/software/updt/2016/02/windows6.1-kb3138612-x64_f7b1de8ea7cf8faf57b0138c4068d2e899e2b266.msu>

Salve o arquivo e execute-o no windows 7 e ele vai instalar a atualização que te possibilitará instalar todas as outras!

![erro2](pics/erro_win7_2.png)

![erro3](pics/erro_win7_3.png)
